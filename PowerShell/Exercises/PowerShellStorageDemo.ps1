...
$storageAccoutKey =(Get-AzureRMStorageAccountKey -ResourceGroupName ftdnt-poc-rg -Name ftdntweb02vmst)[0].value

# Get Context where you would like to upload data 
$storageAccountContext = New-AzureStorageContext -StorageAccountKey $storageAccoutKey -StorageAccountName ftdntweb02vmst
...
.\AzCopy.exe /Source:C:\Users\abhanand\Downloads\data /Dest:https://ftdntweb02vmst.blob.core.windows.net/container1 /DestKey:l5uKYs2Snck3Ltp9D24N77nlPTIB7MMR/bHBAUrcg40f1KdiL8lgrK3rqpI7TpTrOojInbpYls6tLufQlG73YQ== /S /V
