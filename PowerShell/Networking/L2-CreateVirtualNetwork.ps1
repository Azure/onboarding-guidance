...
# Microsoft official Article : https://azure.microsoft.com/en-us/documentation/articles/virtual-networks-create-vnet-arm-ps/#how-to-create-a-vnet-using-powershell 
